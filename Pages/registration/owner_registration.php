...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (isset($_POST['confirm'])) {
        // Generate owner ID and save to database
    ...
    <div class="registration-form">
        ...
        <?php if (isset($_SESSION['registration_complete'])): ?>
            <div class="confirmation-message">
                ...
                <p>Thank you, <?php echo htmlspecialchars($_SESSION['owner_data']['name']); ?>!</p>
                <p>Your Owner ID is: <?php echo htmlspecialchars($_SESSION['owner_id']); ?></p>
            ...
            <?php elseif ($_SESSION['registration_step'] == 3): ?>
                <form method="POST" class="form-step active">
                    ...
                    <div class="review-info">
                        ...
                        <p><strong>National ID:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['national_id']); ?></p>
                        <p><strong>Name:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['name']); ?></p>
                        <p><strong>Address:</strong><br>
                           <?php echo htmlspecialchars($_SESSION['owner_data']['flat_no']); ?><br>
                           <?php echo htmlspecialchars($_SESSION['owner_data']['street']); ?><br>
                           <?php echo htmlspecialchars($_SESSION['owner_data']['city']); ?><br>
                           <?php echo htmlspecialchars($_SESSION['owner_data']['postal_code']); ?></p>
                        <p><strong>Date of Birth:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['dob']); ?></p>
                        <p><strong>Email:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['email']); ?></p>
                        <p><strong>Mobile:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['mobile']); ?></p>
                        <p><strong>Telephone:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['telephone']); ?></p>
                        
                        <h3>Bank Details</h3>
                        <p><strong>Bank Name:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['bank_name']); ?></p>
                        <p><strong>Bank Branch:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['bank_branch']); ?></p>
                        <p><strong>Account Number:</strong> <?php echo htmlspecialchars($_SESSION['owner_data']['account_number']); ?></p>
